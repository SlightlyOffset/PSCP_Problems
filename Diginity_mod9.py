...
the sum of its digits by 9. This is a fundamental property in modular arithmetic and is the
basis for the divisibility rule of 9.

It works because of the mathematical property that any number is congruent to
the sum of its digits modulo 9. When you repeatedly sum the digits, you're essentially
